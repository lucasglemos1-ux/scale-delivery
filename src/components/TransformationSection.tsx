      ...
      <div className="container relative px-5 sm:px-6 md:px-8">
        ...
        >
          ...
          <h2 className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 leading-tight px-1">
            ...
            <span className="gradient-text">pedidos previsíveis</span>
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto px-2">
            que funcionam enquanto você foca no que ama: sua comida.
          </p>
        </motion.div>
        ...
        >
          ...
          {/* After */}
          <motion.div variants={staggerItem} className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-primary/30 to-orange-electric/20 rounded-xl sm:rounded-2xl blur-xl opacity-50" />
