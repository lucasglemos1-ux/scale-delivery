  ...
  return (
    <section id="cta-section" className="relative py-14 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-52 sm:w-60 md:w-72 lg:w-80 h-52 sm:h-60 md:h-72 lg:h-80 bg-blue-electric/15 rounded-full blur-[80px] sm:blur-[100px] md:blur-[120px] animate-float" style={{ animationDelay: '-2s' }} />
      </div>
      ...
      <div className="container relative px-5 sm:px-6 md:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto px-2">
            Dê o primeiro passo rumo ao crescimento previsível. Aplique para um diagnóstico estratégico gratuito e descubra como o SCALE COMPANY pode transformar sua loja de roupas.
          </p>
